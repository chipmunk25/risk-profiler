                        ...
                        <main className="table100 ver1 m-b-110">
                            <Row justify="space-between" className="m-b-20">
                                <Col className="p-l-30">
                                    <h1 className="invoice-id">Profoma #: {details.order_code}</h1>
                                    <div className="date">Date of Profoma: {moment(details.order_date).format('DD/MM/YYYY')}</div>
                                    <div className="date">Expiry Date: {moment(details.expired_date).format('DD/MM/YYYY')}</div>
                                </Col>
