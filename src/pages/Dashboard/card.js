...
const DashboardCard = ({icon, title, subTitle, color, colorTitle, colorSubTitle}) => {
    return (
      ...
      <div className="gx-flex-row gx-justify-content-center gx-mb-3 gx-mb-sm-4">
          <span
            className={`gx-size-80 gx-border gx-border-${colorTitle}
             gx-text-${colorTitle} gx-flex-row gx-justify-content-center gx-align-items-center gx-rounded-circle`}>
